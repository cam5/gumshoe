...
1. Run crow-nester on the URL first. Its outline is your map: what sections exist, how big they render, and — for everything it reports — their real text. Note the selectors of anything you'll need a closer look at later (a candidate windtailor target, a suspected JS-driven section, a fragment worth red-twine's judgment).
...
absolute path: /var/folders/gb/m6478s0n5mx9wqlz8t_c03800000gn/T/gumshoe-agent-run-9YzJFj/clone.html — do not guess at "the current directory" or
...
/var/folders/gb/m6478s0n5mx9wqlz8t_c03800000gn/T/gumshoe-agent-run-9YzJFj — not /tmp or anywhere else, and use a distinct filename per round
